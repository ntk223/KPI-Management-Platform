...
//        BodyData<Object> bodyData = new BodyData(ErrorCode.OK, data, HttpStatus.OK.getReasonPhrase());
//        return new ResultResp(HttpStatus.OK, bodyData);
//    }
//
//    public static ResultResp created() {
//        BodyData<Object> bodyData = new BodyData(ErrorCode.OK, null, HttpStatus.OK.getReasonPhrase());
